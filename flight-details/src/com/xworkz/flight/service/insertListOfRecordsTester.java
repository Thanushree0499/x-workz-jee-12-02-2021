...
public class insertListOfRecordsTester {
	...
	public static void main(String[] args) {
		...
		FlightDTO dto =new FlightDTO(6, "BritishAirways", 400, 7.00, "pune", "mumbai");
		
		FlightDTO dto1 =new FlightDTO(7, "Quatar", 300, 3.00, "hyderabad", "mumbai");
		
		FlightDTO dto2 =new FlightDTO(10, "Kingfisher", 200, 2.00, "chennai", "vishakapatnam");
